<?php /* Smarty version Smarty-3.1.7, created on 2014-10-30 09:12:01
         compiled from "C:\Program Files (x86)\vtigerCRM610\apache\htdocs\vtigerCRM\includes\runtime/../../layouts/vlayout\modules\Settings\ModuleManager\ImportUserModuleStep2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:25925545200e1a6d937-20822534%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9d4c7fc1094675cdc548dfda7879a87967927563' => 
    array (
      0 => 'C:\\Program Files (x86)\\vtigerCRM610\\apache\\htdocs\\vtigerCRM\\includes\\runtime/../../layouts/vlayout\\modules\\Settings\\ModuleManager\\ImportUserModuleStep2.tpl',
      1 => 1407162758,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '25925545200e1a6d937-20822534',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_545200e1c5a92',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_545200e1c5a92')) {function content_545200e1c5a92($_smarty_tpl) {?>
...
</p></div></div></div><?php }?><br><div class="row-fluid"><div class="span7"><?php if ($_smarty_tpl->tpl_vars['MODULEIMPORT_EXISTS']->value!='true'){?><input type="checkbox"  class="acceptLicense"> <?php echo vtranslate('LBL_LICENSE_ACCEPT_AGREEMENT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
<?php }?>&nbsp;</div><div class="span5"><span class="pull-right"><?php if ($_smarty_tpl->tpl_vars['MODULEIMPORT_EXISTS']->value=='true'||$_smarty_tpl->tpl_vars['MODULEIMPORT_DIR_EXISTS']->value=='true'){?><?php if ($_smarty_tpl->tpl_vars['MODULEIMPORT_EXISTS']->value=='true'){?><input type="hidden" name="module_import_file" value="<?php echo $_smarty_tpl->tpl_vars['MODULEIMPORT_FILE']->value;?>
...
</button><?php }?><div class=" pull-right cancelLinkContainer"><a class="cancelLink" type="reset" data-dismiss="modal" onclick="javascript:window.history.back();"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a></div></span><?php }else{ ?><input type="hidden" name="module_import_file" value="<?php echo $_smarty_tpl->tpl_vars['MODULEIMPORT_FILE']->value;?>
"><input type="hidden" name="module_import_type" value="<?php echo $_smarty_tpl->tpl_vars['MODULEIMPORT_TYPE']->value;?>
"><input type="hidden" name="module_import_name" value="<?php echo $_smarty_tpl->tpl_vars['MODULEIMPORT_NAME']->value;?>
